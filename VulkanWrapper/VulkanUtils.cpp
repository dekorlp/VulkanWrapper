...
bool CVulkanUtils::checkDeviceExtensionSupport(CVulkanInstance vulkanInstance, VkPhysicalDevice device) {
	...
	std::vector<VkExtensionProperties> deviceExtension = vulkanInstance.getExtensions();

	SVulkanExtensions sVulkanExtensions;

	std::set<std::string> requiredExtensions(sVulkanExtensions.logicalDeviceExtensions.begin(), sVulkanExtensions.logicalDeviceExtensions.end());
...
VkCommandBuffer CVulkanUtils::beginSingleTimeCommands(VkDevice device, VkCommandPool commandPool)
{
...
void CVulkanUtils::endSingleTimeCommands(VkDevice device, VkCommandPool commandPool, VkCommandBuffer commandBuffer, VkQueue graphicsQueue)
{
